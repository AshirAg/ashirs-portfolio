  ...
  return (
    <div className="section">
      <div className={`container ${styles.container}`}>
        <h1>Games</h1>
        <p>
          Welcome to the games section! Here are some games for you to kill your
          time.{" "}
        </p>
        <p>
          These games are my personal hobby projects, games will keep on adding
          as time passes. Stay tunned for new Games.
        </p>
