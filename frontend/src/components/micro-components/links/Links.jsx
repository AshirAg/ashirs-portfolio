...
function Links(){
    return(
        <div className={styles.links}>
            ...
            <a href="https://linkedin.com/in/ashir-agrawal"  aria-label="Linkedin Link" target='_blank'><LuLinkedin /></a>
            <a href="mailto: work@ashiragrawal.com.np" aria-label="Send Email"><MdOutlineMailOutline /></a>
