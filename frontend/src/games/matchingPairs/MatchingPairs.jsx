...
const MatchingPairs = () => {
  ...
  const [cells, setCells] = useState(generateBoard(totalCells));
      ...
      <div className="section">
        <div className={`${styles.container} container`}>
          ...
          <div className={styles.dashboard}>
            <select onChange={(e) => setTotalCells(Number(e.target.value))}>
            ...
            {cells.map((cell) => (
              <div
                ...
                className={`${styles.card} ${
                  cell.flipped ? styles.flipped : ""
                } ${cell.matched ? styles.matched : ""}`}
